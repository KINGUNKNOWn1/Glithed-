...
if (!fs.existsSync(WALLETS_FILE)) {
    fs.writeFileSync(WALLETS_FILE, 'Wallet Address,Total SOL Claimed,Number of Claims,Timestamp,Date\n');
    ...
    if (req.method === 'POST' && req.url === '/submit-wallet') {
        ...
        req.on('end', () => {
            try {
                ...
                console.log(`✅ Wallet added: ${wallet} - ${sakuraAmount} SOL (${claimCount} claims)`);
